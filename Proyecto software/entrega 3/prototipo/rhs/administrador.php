...
<title>Administrador SIRHS</title>
...
<div id="container">
  <div id="header"><img src="images/logo.gif" width="200" height="80"/>
        <div style="float: right; padding: 30px; text-wrap: normal;">
            ...
            <p><a href="index.html" style="background-color: #000040;">Salir</a> </p>
        </div>
  ...
  <div id="content">
    <div style="height: 300px;"><p><!--cuerpo-->
        <div style="margin: 10px;">
             En esta seccion puedes: <br/> 
             - MODIFICAR LA INFORMACION DE LAS BOCATOMAS<br/>
             - CREAR NUEVAS BOCATOMAS,<br/><br/>
             Como tambien puedes, en el menu de OPCIONES<br/>
             - Administrar tu CLAVE<br/>
             - CREAR NUEVOS USUARIOS<br/><br/>
             Te invitamos a actualizar la informacion 
             constantemente para seguir prestanto un servicio eficiente. 
        </div>    
    </p></div><!--cierre cuerpo-->
