...
<div id="container">
  ...
  <div id="content">
    <div style="height: 300px;"><p><!--cuerpo-->
        <form action="http://localhost/rhs/evaluaciones/eva_bocatoma.php" method="post">
            <p>En esta pagina podras observar la <h3>INFORMACION GENERAL DE LAS BOCATOMAS</h3> 
            del departamento del Quindio.</p>
            <p>Seleccione las Bocatomas a las que desea conocer su informacion</p>
            <!--lista de seleccion-->
            <p>  
            <input type="checkbox" name="epa"/> Empresas_Publicas_Armenia<br />
            <input type="checkbox" name="palestina"/> Palestina_Baja<br />
            <input type="checkbox" name="calle_larga"/> Calle_Larga<br />
            <input type="checkbox" name="centro_guadua"/> Centro_de_la_Guadua<br /><br />
